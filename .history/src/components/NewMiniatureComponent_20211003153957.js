          ...
          <tr>
            ...
            <td>
              <button
                onClick={() =>
                  this.props.onNew([
                    this.state.newModel[0],
                    this.state.newModel[1],
                    this.state.newModel[2],
                    this.state.newModel[3],
                  ])
                }
              >
                ADD NEW

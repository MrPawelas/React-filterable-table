...
export class FilterAndSortComponent extends React.Component {
    ...
    createFilter() {
        ...
        if(this.state.nameFilter) {
            ...
            filter =  (model) => {return (   true && (new RegExp(this.state.nameFilter, 'i')).test(model[0]))}
        }
        return filter
        ...
        return (
            <Container fluid >
                ...
                <Col className="text-start"> <label>Sorting: &emsp;</label>
                    ...
                    <Col className="text-start">Name: <input type="text" value={this.state.nameFilter} onChange={this.onFilterInputChange}/></Col>
                    <Col className="text-start">Name: <input type="text" value={this.state.nameFilter} onChange={this.onFilterInputChange}/></Col>
                    <Col className="text-start">Name: <input type="text" value={this.state.nameFilter} onChange={this.onFilterInputChange}/></Col>

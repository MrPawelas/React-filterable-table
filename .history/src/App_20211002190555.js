...
class App extends React.Component {
  constructor() {
    super();
    this.state = {
      lastNewAdded : 0, //name is a key in table so to avoid bug of adding multiple new empty row i add unique number to every new name
      models: [
  ...
  onNew() {
    ...
    this.setState({
      lastNewAdded : lastNewAdded+1,
      models: [["Unique name of model" +lastNewAdded, "Description", "link to image", 0], ...this.state.models]
    })
  }
  render() {
    return (

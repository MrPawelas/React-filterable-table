...
class App extends React.Component {
  constructor(){
    ...
    ["Fellowship Of The Ring", "ThRing as well as one Ring Priority Marker",
    "https:",5],
  ...
  onDelete(miniatureName){
    const filteredModels = this.state.models.filter(miniature => miniature.name !== miniatureName)
    console.log(miniatureName)
    this.setState({
